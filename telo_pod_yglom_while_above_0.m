% Движение под углом к горизонту c циклом while
clear all;
...
if method == 2
    ...
    while U(m,2)>=0
        ...
        z=sqrt(1+Uw1(m-1,3)^2+Uw1(m-1,4)^2+(-k/massa*Uw1(m-1,3))^2+(-g-k/massa*Uw1(m-1,4))^2);
...
if method == 3
    ...
    while U(m,2)>=0
        ...
        z=sqrt(1+Uw2(m-1,3)^2+Uw2(m-1,4)^2+(-k/massa*Uw2(m-1,3))^2+(-g-k/massa*Uw2(m-1,4))^2);
...
if method == 4
    ...
    while U(m,2)>=0
        ...
        z=sqrt(1+Uw3(m-1,3)^2+Uw3(m-1,4)^2+(-k/massa*Uw3(m-1,3))^2+(-g-k/massa*Uw3(m-1,4))^2);
